...
public final class ItemFileCardLargeBinding implements ViewBinding {
  @NonNull
  ...
  private ItemFileCardLargeBinding(@NonNull FrameLayout rootView, @NonNull LinearLayout actionRow,
  ...
  @NonNull
  public static ItemFileCardLargeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemFileCardLargeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_file_card_large, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemFileCardLargeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFileCardLargeBinding((FrameLayout) rootView, actionRow, btnDelete, btnDownload,
